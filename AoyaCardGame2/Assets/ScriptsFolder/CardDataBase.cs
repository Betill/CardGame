...
public class CardDataBase: MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        testEffects.Add(new DrawCardsEffect(playerDeck, enemyDeck, 2));
        testEffects.Add(new HealEffect(playerScript, enemyScript, 10));
        testEffects.Add(new SkipTurnsEffect(turnsController, 1));
